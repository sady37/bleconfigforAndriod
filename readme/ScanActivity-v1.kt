Changes in v1.0:
1. Initial version
2. Support scanning for both Radar and SleepBoard devices 
3. Use Intent approach to call scanning modules
4. Filter Radar devices by TSBLU prefix (optional)
5. Display MAC address, config time and RSSI for scanned devices
6. Keep up to 100 successful config records

Files changed:
1. ScanActivity.kt - Added device scanning UI and logic
2. activity_scan.xml - Added scan activity layout
3. item_device.xml - Added device list item layout
